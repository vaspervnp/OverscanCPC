;; Generated by tools/mktext.py from assets/font.txt - do not edit.
;;
;; 5x8 glyphs in a 6 pixel cell, drawn 7 tall; the sixth column and the
;; bottom row are the spacing. Greek capitals sharing a Latin shape are not
;; repeated; the text tool folds them onto the Latin glyph.
