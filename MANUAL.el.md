...
![Πράξη δεύτερη: έξω από το σπίτι, στην πίσω αυλή, με το φως.](docs/loukoumas-backyard-el.png)

![Πράξη τρίτη: ο δρόμος του γυρισμού, από τις ταράτσες.](docs/loukoumas-rooftops-el.png)
...
![Το σαλόνι: το HUD επάνω, πέντε λουκάνικα, κι ένα ρομπότ στο ράφι.](docs/loukoumas-lounge-el.png)
...
![Το Pitsos στην κουζίνα, επιτέλους ανοιχτό — και άδειο.](docs/loukoumas-kitchen-el.png)
...
![Τέλος ζωών. Το FIRE ξαναρχίζει, το ESC γυρίζει στην αρχική.](docs/loukoumas-gameover-el.png)
