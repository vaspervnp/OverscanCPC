...
**Είκοσι εννιά πίστες. Τρεις ζωές. Ένα λουκάνικο.**
...
| **ΖΩΕΣ** | Ξεκινάτε με τρεις. Πέντε το πολύ |
...
πίσω**, ως πέντε το πολύ. Αν οι ζωές σας είναι ήδη γεμάτες, αξίζει 500 πόντους.
...
|---|---|
| Λουκάνικο | 100 |
| Μπολ με γάλα | μία ζωή — ή 500 πόντοι αν έχετε ήδη πέντε |
...
Χάστε και την τρίτη ζωή και η πίστα παγώνει εκεί που είναι, με το **ΤΕΛΟΣ**
...
* **Πάρτε το γάλα νωρίς.** Είναι στο δυσκολότερο ράφι της πίστας και δεν θα
  θέλετε να γυρίσετε για αυτό με την τελευταία σας ζωή.
